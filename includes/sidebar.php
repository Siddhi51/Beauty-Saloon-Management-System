<div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            <li>
              <a href="dashboard.php"><i class="fa fa-home nav_icon"></i>Home</a>
            </li>
            <li>
        ...
        <li><a href="unreadenq.php">Unread Enquiry</a></li>
             ...
             <li>
              ...
              <li>
              <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Payments<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="all-payments.php">All Payments</a>
                </li>
        
                <li>
                  <a href="search-payments.php">Search Payments</a>
                </li>
              </ul>
            </li>
