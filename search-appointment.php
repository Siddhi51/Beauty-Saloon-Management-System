...
<body class="cbp-spmenu-push">
	...
	<div class="form-body">
							<form method="post" name="search" action="">
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1" style="padding-bottom: 20px;">Search by Appointment Number / Phone Number </label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
