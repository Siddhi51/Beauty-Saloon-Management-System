...
<?php
$ret=mysqli_query($con,"select tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tblbook.ID as bid,tblbook.AptNumber,tblbook.AptDate,tblbook.AptTime,tblbook.Message,tblbook.BookingDate,tblbook.Status from tblbook join tbluser on tbluser.ID=tblbook.UserID where tblbook.Status='Rejected' ORDER BY tbluser.FirstName");
$cnt=1;
...
?>
                     ...
                     <td class="font-w600" style="color:darkred;"><?php echo "Not Updated Yet"; ?></td>
                     <?php } else { ?>
                      <td style="color:orangered;"><?php  echo $row['Status'];?></td><?php } ?> 
                                         <td>
